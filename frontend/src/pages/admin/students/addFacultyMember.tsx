...
// Mock Data - Cleaned up for unique display
const MOCK_STUDENTS = [
    ...
    { id: "STU003", firstName: "Jose", lastName: "Rizal", email: "jose@school.edu", gradeLevel: "7" },
    { id: "STU004", firstName: "Andres", lastName: "Bonifacio", email: "andres@school.edu", gradeLevel: "7" },
    { id: "STU005", firstName: "Emilio", lastName: "Aguinaldo", email: "emilio@school.edu", gradeLevel: "7" },
    { id: "STU006", firstName: "Apolinario", lastName: "Mabini", email: "mabini@school.edu", gradeLevel: "7" },
    { id: "STU007", firstName: "Melchora", lastName: "Aquino", email: "tandang.sora@school.edu", gradeLevel: "7" },
    { id: "STU008", firstName: "Gabriela", lastName: "Silang", email: "gabriela@school.edu", gradeLevel: "7" },
    { id: "STU009", firstName: "Pedro", lastName: "Penduko", email: "pedro@school.edu", gradeLevel: "8" },
    { id: "STU010", firstName: "Sisa", lastName: "Rizal", email: "sisa@school.edu", gradeLevel: "9" },
    { id: "STU011", firstName: "Crisostomo", lastName: "Ibarra", email: "ibarra@school.edu", gradeLevel: "10" },
];
...
export default function CreateSubjectPage() {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        if (name === "gradeLevel") {
            // Reset enrolled students if grade level changes to maintain consistency
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        console.log("Full Object Data:", formData);
        // -----------------------------

        setTimeout(() => {
            setLoading(false);
            alert(`Subject "${formData.subjectTitle}" created successfully with ${formData.enrolledStudents.length} students! Check the console for data.`);
            navigate(-1);
        }, 1000);
    };
                ...
                <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div className="pt-6 flex items-center gap-3">
                            ...
                            <button type="submit" disabled={loading || !formData.gradeLevel || !formData.subjectTitle} className="flex-1 px-4 py-2.5 bg-indigo-600 text-white rounded-lg font-medium hover:bg-indigo-700 transition-all shadow-md disabled:bg-indigo-300">
