...
import { Book, ChevronRight, ClipboardList } from "lucide-react";
          ...
          return (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-3">
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase">Room {s.room}</span>
              </div>
              ...
              <Link
                ...
                onClick={(e) => e.stopPropagation()} // prevents triggering article onClick when clicking Link
