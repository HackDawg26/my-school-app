...
export function AssignmentSubmitForm({ assignment, onSuccess }: AssignmentSubmitFormProps) {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    toast({
      ...
      description: `Your work for "${assignment.title}" has been submitted successfully.`,
    });
    onSuccess();
  }
